    ...
    def forward(
        ...
        **kwargs,
        ...
        if token_skip_manager is not None:
            skip_plan = token_skip_manager.build_layer_skip_plan(
        ...
        run_active_only = (
            skip_plan is not None
            and skip_plan["did_skip"]
        ...
        if run_active_only:
            ...
            active_attn_output = self.self_attn.forward_active_queries(
                hidden_states=skip_plan["mixed_ln_hidden"],
